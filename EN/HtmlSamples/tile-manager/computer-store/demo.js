$(function () {
            ...
            $('#dashboard').igTileManager({
                ...
                maximizedState: '<h3 class="name">${name}</h3>' +
                    ...
                    '<button id="btn-add" value="Add to cart"><img class="cart-icon-small" src="http://dev.igniteui.local/13-2/images/samples/tile-manager/computer-store/cart.png" />Add to cart</button>',
                minimizedState: '<h4 class="name">${name}</h4><img src="${featuredPicture}" class="minimized" title="${name}" alt="error" />' +
                    ...
                    '<div>Price: <span class="price">$${price}</span><a href="#"></a><img title="Add to cart" class="cart-icon" src="http://dev.igniteui.local/13-2/images/samples/tile-manager/computer-store/cart.png" /></div>',

$(function () {
            ...
            if (window.History && window.History.Adapter) {
				window.History.Adapter.bind(window, 'statechange', function (e, args) {
					var currState, state, stateOccurances;
            ...
            function getPreviousStateOccurances(id) {
